...
namespace SeleniumTest
{
    ...
    public partial class dbNtlSystemEntities : DbContext
    {
        ...
        public virtual int NSP_TNtlSeleniumLog_Insert(string log_name, Nullable<int> type, Nullable<System.DateTime> start_date, Nullable<System.DateTime> end_date, Nullable<int> platform_id, string status, string remarks)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("NSP_TNtlSeleniumLog_Insert", log_nameParameter, typeParameter, start_dateParameter, end_dateParameter, platform_idParameter, statusParameter, remarksParameter);
        }
    
        public virtual int NSP_TNtlSeleniumLog_Update(Nullable<int> id, string log_name, Nullable<int> type, Nullable<System.DateTime> start_date, Nullable<System.DateTime> end_date, Nullable<int> platform_id, string status, string remarks)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
